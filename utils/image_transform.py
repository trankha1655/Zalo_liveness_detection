...
class RandomScaleCrop(object):
    def __init__(self, base_size = 720, crop_size=400, fill=0):
    ...
    def get_short_size(self, w, h):
        ...
        if temp < self.base_size:

            short_size = random.randint(int(self.base_size * 0.7), int(self.base_size * 1.0))
            return short_size

        short_size = random.randint(int(self.base_size * 1), int(self.base_size * 1.15))
        return short_size
